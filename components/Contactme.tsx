      ...
      >
        <Form className="flex flex-col justify-center ml-6 ">
         <label className="text-xl mb-2" htmlFor="name">NAME:</label>
          <Field className="focus:outline-none focus:ring-2 ring-green-600 px-3 py-2 w-96 rounded-sm " placeholder="Your Name" type="text" name="name" />
        <div className="text-red-500 "><ErrorMessage name="name"/></div>  
          <label className="text-xl mt-5 mb-2"  htmlFor="email">E-MAIL:</label>
          <Field className="focus:outline-none focus:ring-2 ring-green-600 px-3 py-2 w-96 rounded-sm " placeholder="Your Email" type="email" name="email"  />
