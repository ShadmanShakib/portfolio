...
function ProjectCard({items}:any):JSX.Element {
    ...
    return (
      <React.Fragment>
        ...
        <h1 className="text-2xl font-semibold py-2 px-5 rounded-md text-white bg-green-500">ProjectCard</h1>
        </div>
      <div className="grid xl:grid-cols-3 mb-10 gap-x-3 gap-y-6 px-3 mt-10 justify-items-center">
        ...
        return(
          <div key={id} className="">
            <a href={`https://www.youtube.com/watch?v=${resourceId.videoId}`} rel="noopener noreferrer" target="_blank">
